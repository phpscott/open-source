...
# no funny business yet, no arg passed, just run it. php fpi.php
# s3://zype-filmhub
 ...
 *      Build MRSS Import file compliant to zype.com
    ...
    "DIRLIST"           => "dirlist/", keep untouched

    "YMLJSON"           => "yaml_json/", // clean on full run
    "YAML"              => "yaml/", // clean on full run
    "XMLITEMS"          => "xmlitems/", // clean on full run
    "XMLSERIESITEMS"    => "xmlitems_series/", // clean on full run
    "XMLTRAILERITEMS"   => "xmlitems_trailers/", // clean on full run
    "OBJECTS"           => "objects/", // clean on full run
    "SKUIDS"            => "skuids/", // clean on full run
    "BADSKUIDS"         => "badskuids/", // clean on full run
    "MRSSIMPORT"        => "mrssimport/", // clean on full run
    "POSTINGEST"        => "postingest/" // clean on full run
